...
class BottomLeftThumb extends Component {
    ...
    bottomleft=()=>{
        ...
        {
          document.getElementById('Homebottomleft').style.left='-290px'
          document.getElementById('Homearrow1').style.transform="scaleX(1)"
          this.setState({isOpen:false})
    }
        else
        {
          document.getElementById('Homearrow1').style.transform="scaleX(-1)";
          document.getElementById('Homebottomleft').style.left='0px'
    ...
    render() { 
        ...
        return ( <div id="Homebottomleft" className="HomeBottomLeftThumb">

      
<div className="Homeshadow Homearrowbox2"  style={{float:'right'}} onClick={this.bottomleft}>
          <ArrowForwardIosIcon color="primary" style={{color:'#8B90A0'}} id='Homearrow1'/>
        </div>


       
         <div  className="Homeshadow Homelistbox1" style={{}}>
